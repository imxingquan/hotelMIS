...
void CCancelMenuSearchDlg::Refresh()
{
	...
	m_GuiListCtrl.InsertItem(i,_T("合计:"));
	t.Format("%.2f",sum);
...
{
	int i = 0;
	m_GuiListCtrl.InsertColumn(i++,_T("退菜菜名"),LVCFMT_LEFT,160);
	m_GuiListCtrl.InsertColumn(i++,_T("价格"),LVCFMT_RIGHT,70);
	m_GuiListCtrl.InsertColumn(i++,_T("数量"),LVCFMT_CENTER,50);
	m_GuiListCtrl.InsertColumn(i++,_T("单位"),LVCFMT_CENTER,50);
	m_GuiListCtrl.InsertColumn(i++,_T("退菜原因"),LVCFMT_LEFT,150);
...
void  CCancelMenuSearchDlg::Draw(CDC &memDC, PRNINFO PrnInfo)
{
	...
	TCHAR szTitle[255];
	wsprintf(szTitle,TEXT("%s 退菜明细报表"),m_hotelname.GetBuffer());
	...
	//标题
		...
		memDC.DrawText("退单商品", &rt1, DT_CENTER | DT_VCENTER | DT_SINGLELINE);
		memDC.DrawText("价格", &rt2, DT_CENTER | DT_VCENTER | DT_SINGLELINE);
		memDC.DrawText("数量", &rt3, DT_CENTER | DT_VCENTER | DT_SINGLELINE);
		memDC.DrawText("单位", &rt4, DT_CENTER | DT_VCENTER | DT_SINGLELINE);
		memDC.DrawText("退菜原因", &rt5, DT_CENTER | DT_VCENTER | DT_SINGLELINE);
	...
	else
	{
		...
		memDC.DrawText("退菜商品", &rt1, DT_CENTER | DT_VCENTER | DT_SINGLELINE);
		memDC.DrawText("价格", &rt2, DT_CENTER | DT_VCENTER | DT_SINGLELINE);
		memDC.DrawText("数量", &rt3, DT_CENTER | DT_VCENTER | DT_SINGLELINE);
		memDC.DrawText("单位", &rt4, DT_CENTER | DT_VCENTER | DT_SINGLELINE);
		memDC.DrawText("退菜原因", &rt5, DT_CENTER | DT_VCENTER | DT_SINGLELINE);
