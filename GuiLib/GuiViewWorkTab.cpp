...
BOOL CGuiViewWorkTab::OnCmdMsg(UINT nID, int nCode, void* pExtra, AFX_CMDHANDLERINFO* pHandlerInfo)
{
	// TODO: 在此添加专用代码和/或调用基类
	m_guiWorktab.OnCmdMsg( nID,  nCode, pExtra, pHandlerInfo);
	return CView::OnCmdMsg(nID, nCode, pExtra, pHandlerInfo);
}

//void CGuiViewWorkTab::OnActivate(UINT nState, CWnd* pWndOther, BOOL bMinimized)
//{
...
//void CGuiViewWorkTab::OnShowWindow(BOOL bShow, UINT nStatus)
//{
